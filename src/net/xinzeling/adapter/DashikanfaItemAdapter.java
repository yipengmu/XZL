...
public class DashikanfaItemAdapter extends BaseAdapter {
	...
	public DashikanfaItemAdapter(Context ctx, Typeface tf) {
		...
		// String[] item1 = {"1","1","0","2014-10-11","click_id"};//内部编号 是否是日期标题
		// 是否读过 标题值 新闻id
	...
	public void setData(JSONArray arr) throws JSONException {
		...
		List<Map.Entry<String, ArrayList<JSONObject>>> infoIds = new ArrayList<Map.Entry<String, ArrayList<JSONObject>>>(date_data_map.entrySet());

		Collections.sort(infoIds, new Comparator<Map.Entry<String, ArrayList<JSONObject>>>() {

			@Override
			public int compare(Entry<String, ArrayList<JSONObject>> arg0, Entry<String, ArrayList<JSONObject>> arg1) {
